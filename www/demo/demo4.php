...
<body>
<h1> GOVERNMENT LOGIN - PORTAL 4 </h1>
...
mysql_select_db("demo") or die(mysql_error());
    ...
    <form action="demo4.php" method="post">
      ...
      <input type="password" name="password" value='<?=htmlspecialchars($pass) ?>'> PASSWORD </input><br />
      <input class="button" type="submit" value="Submit" />
    </form>
    <?php
    if($user!=""){
      echo("INCORRECT CREDENTIALS FOR <strong>".htmlspecialchars($user)."</strong>");
    }
  }
